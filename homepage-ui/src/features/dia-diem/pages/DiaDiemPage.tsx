...
const provincePaiData: Record<string, StarChartDataPoint[]> = {
  "Hà Nội": [
    { criterion: "Hạ tầng sẵn có", value: 5, fullMark: 5 },
    { criterion: "Hỗ trợ tài chính", value: 4, fullMark: 5 },
...
function LocationCard({ title, location, verified = true, image, href }: LocationCardProps) {
  const [liked, setLiked] = useState(false);
  return (
    <Link href={href} className="bg-white rounded-xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] overflow-hidden flex flex-col hover:shadow-lg transition-shadow">
...
const defaultLocations = [
  { id: 1, slug: "hang-en", title: "Hang Én", location: "Bố Trạch, Quảng Bình", verified: true, image: imgLocationDefault },
  { id: 2, slug: "hang-son-doong", title: "Hang Sơn Đoòng", location: "Bố Trạch, Quảng Bình", verified: true, image: imgLocationDefault },
  { id: 3, slug: "vinh-ha-long", title: "Vịnh Hạ Long", location: "Hạ Long, Quảng Ninh", verified: true, image: imgLocationDefault },
  { id: 4, slug: "pho-co-hoi-an", title: "Phố cổ Hội An", location: "Hội An, Quảng Nam", verified: true, image: imgLocationDefault },
  { id: 5, slug: "moc-chau", title: "Mộc Châu", location: "Mộc Châu, Sơn La", verified: true, image: imgLocationDefault },
  { id: 6, slug: "da-lat", title: "Đà Lạt", location: "Đà Lạt, Lâm Đồng", verified: true, image: imgLocationDefault },
];

const hanoiLocations = [
  { id: 1, slug: "ho-hoan-kiem", title: "Hồ Hoàn Kiếm",              location: "Hàng Trống, Hoàn Kiếm, Hà Nội",               verified: true, image: imgHoHoanKiem },
  { id: 2, slug: "van-mieu-quoc-tu-giam", title: "Văn Miếu Quốc Tử Giám",     location: "58 Quốc Tử Giám, Văn Miếu, Đống Đa, Hà Nội", verified: true, image: imgVanMieu },
  { id: 3, slug: "lang-chu-tich-ho-chi-minh", title: "Lăng Chủ tịch Hồ Chí Minh", location: "Số 2 Hùng Vương, Hà Nội",                     verified: true, image: imgLangHCM },
  { id: 4, slug: "hoang-thanh-thang-long", title: "Hoàng thành Thăng Long",     location: "Số 19C Hoàng Diệu, Hà Nội",                   verified: true, image: imgHoangThanhThangLong },
  { id: 5, slug: "nha-tho-lon-ha-noi", title: "Nhà thờ Lớn Hà Nội",        location: "Số 40 Nhà Chung, Hoàn Kiếm, Hà Nội",          verified: true, image: imgNhaThoLon },
  { id: 6, slug: "chua-thay", title: "Chùa Thầy",                 location: "Xã Quốc Oai, Hà Nội",                          verified: true, image: imgChuaThay },
];
...
function ProvincePanel({ province }: { province: string }) {
  ...
  const chartData = provincePaiData[province] ?? [
    ...
    { criterion: "Hỗ trợ tại thực địa", value: 3, fullMark: 5 },
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="shrink-0 flex flex-col items-center gap-1">
          <div className="relative w-[220px] h-[180px]">
            <div className="absolute left-1/2 top-[52%] -translate-x-1/2 -translate-y-1/2 w-[160px] h-[160px]">
              <StarChart
                data={chartData}
                width={160}
                height={160}
