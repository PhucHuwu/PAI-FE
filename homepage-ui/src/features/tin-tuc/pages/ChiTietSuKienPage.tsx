      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <main className="flex-1 max-w-[1440px] mx-auto w-full px-8 py-6">
          ...
          <div className="flex items-center gap-2 mb-4">
            <Link href="/" className="text-black/50 text-base hover:text-[#fb7104] transition-colors">Trang chủ</Link>
            <span className="text-black/50 text-base">/</span>
            <Link href="/tin-tuc" className="text-black/50 text-base hover:text-[#fb7104] transition-colors">Tin tức</Link>
            <span className="text-black/50 text-base">/</span>
            <Link href="/tin-tuc/su-kien" className="text-black/50 text-base hover:text-[#fb7104] transition-colors">Sự kiện</Link>
          </div>
