...
const TRENDING_LOCATIONS: RankingItem[] = [
  ...
  { rank: 2,  name: 'Phố cổ Hội An',                   city: 'Đà Nẵng',          score: '9.810' },
  ...
  { rank: 10, name: 'Mỹ Sơn Thánh địa',                city: 'Đà Nẵng',          score: '9.688' },
  { rank: 11, name: 'Vườn quốc gia Phong Nha',         city: 'Quảng Trị',        score: '9.672' },
  { rank: 12, name: 'Hồ Gươm',                         city: 'Hà Nội',           score: '9.655' },
  { rank: 13, name: 'Bãi biển Mỹ Khê',                 city: 'Đà Nẵng',          score: '9.641' },
  { rank: 14, name: 'Cung đường đèo Hải Vân',          city: 'Huế',              score: '9.623' },
  { rank: 15, name: 'Đảo Phú Quốc',                    city: 'An Giang',         score: '9.607' },
];
...
const INFRASTRUCTURE_RANKINGS: RankingItem[] = [
  ...
  { rank: 7,  name: 'TP. Hồ Chí Minh',  city: 'Miền Nam',  score: '9.698' },
  ...
  { rank: 11, name: 'Huế',               city: 'Miền Trung',score: '9.608' },
...
const FINANCIAL_SUPPORT_RANKINGS: RankingItem[] = [
  ...
  { rank: 8,  name: 'Lâm Đồng',          city: 'Tây Nguyên',score: '9.740' },
  { rank: 9,  name: 'Lâm Đồng',          city: 'Tây Nguyên',score: '9.718' },
  { rank: 10, name: 'An Giang',          city: 'Miền Nam',  score: '9.694' },
  { rank: 11, name: 'Gia Lai',           city: 'Tây Nguyên',score: '9.671' },
  { rank: 12, name: 'Huế',               city: 'Miền Trung',score: '9.648' },
  { rank: 13, name: 'Nghệ An',           city: 'Miền Trung',score: '9.623' },
  { rank: 14, name: 'Đồng Nai',          city: 'Miền Nam',  score: '9.601' },
  { rank: 15, name: 'Phú Thọ',           city: 'Miền Bắc',  score: '9.578' },
];
...
const INFORMATION_SUPPORT_RANKINGS: RankingItem[] = [
  ...
  { rank: 10, name: 'TP. Hồ Chí Minh',  city: 'Miền Nam',  score: '9.679' },
  { rank: 11, name: 'Huế',               city: 'Miền Trung',score: '9.654' },
  { rank: 12, name: 'Đắk Lắk',           city: 'Tây Nguyên',score: '9.630' },
  { rank: 13, name: 'Lâm Đồng',          city: 'Tây Nguyên',score: '9.607' },
...
const FIELD_SUPPORT_RANKINGS: RankingItem[] = [
  ...
  { rank: 4,  name: 'Đà Nẵng',           city: 'Miền Trung',score: '9.845' },
  ...
  { rank: 10, name: 'Gia Lai',           city: 'Tây Nguyên',score: '9.700' },
  { rank: 11, name: 'Huế',               city: 'Miền Trung',score: '9.675' },
  ...
  { rank: 15, name: 'An Giang',          city: 'Miền Nam',  score: '9.576' },
];
