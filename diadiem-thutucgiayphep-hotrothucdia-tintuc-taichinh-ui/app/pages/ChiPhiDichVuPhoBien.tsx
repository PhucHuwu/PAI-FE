...
import imgHeroBg from "figma:asset/0cc2640c46d620d6b41eb7ed53406956f72892ae.png";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f0ede8]">
      ...
      <section className="relative w-full overflow-hidden" style={{ minHeight: 340 }}>
        ...
        {/* Back button */}
        <Link to="/tai-chinh" className="absolute top-5 left-8 flex items-center gap-2 text-black text-base hover:text-[#fb7104] transition-colors z-10">
