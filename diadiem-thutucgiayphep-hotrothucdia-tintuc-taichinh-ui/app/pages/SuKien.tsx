...
// ─── Figma image ──────────────────────────────────────────────────────────────
import imgEventCard from "figma:asset/e34c4d0d854410b26b2223d2219c35ddb488b27a.png";
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 max-w-[1440px] mx-auto w-full px-8 py-6">
          ...
          <div className="flex items-center gap-2 text-black text-base mb-4">
            ...
            <span>/</span>
            <Link to="/tin-tuc" className="hover:text-[#fb7104] transition-colors">Tin tức</Link>
            <span>/</span>
