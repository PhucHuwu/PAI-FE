...
import imgRectangle277 from "figma:asset/e34c4d0d854410b26b2223d2219c35ddb488b27a.png";
...
function Group3() {
  return (
    <div className="absolute contents inset-[3.51%_3.8%_90.06%_71.02%]">
      <div className="absolute bg-[#0770e0] inset-[3.51%_3.8%_90.06%_71.02%] rounded-[16px]" />
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold inset-[3.51%_3.8%_90.06%_71.02%] justify-center leading-[0] not-italic text-[15px] text-center text-white">
        <p className="leading-[normal]">Đã diễn ra</p>
      </div>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents inset-0">
      <div className="absolute inset-[0_0_30.7%_0] pointer-events-none rounded-tl-[8px] rounded-tr-[8px]">
        <div className="absolute inset-0 overflow-hidden rounded-tl-[8px] rounded-tr-[8px]">
          <img alt="" className="absolute h-[133.23%] left-0 max-w-none top-[-29.39%] w-full" src={imgRectangle277} />
        </div>
        <div aria-hidden="true" className="absolute border border-[#c6c6c6] border-solid inset-0 rounded-tl-[8px] rounded-tr-[8px]" />
      </div>
      <div className="absolute bg-[#fffaf5] border border-[#c6c6c6] border-solid inset-[69.01%_0_0_0] opacity-80 rounded-bl-[8px] rounded-br-[8px]" />
      <div className="absolute flex flex-col font-['Inter:Medium',sans-serif] font-medium inset-[70.76%_7.13%_16.08%_7.36%] justify-center leading-[0] not-italic text-[24px] text-black text-justify">
        <p className="leading-[normal]">Festival Hoa Đà Lạt 2024</p>
      </div>
      <div className="absolute flex flex-col font-['Inter:Light',sans-serif] font-light inset-[81.87%_7.13%_4.97%_7.36%] justify-center leading-[0] not-italic text-[20px] text-black text-justify">
        <p className="leading-[normal]">Không gian bối cảnh cổ điển theo thiên hướng Pháp lãng mạn và...</p>
      </div>
      <Group3 />
    </div>
  );
...
function Group9() {
  return (
    <div className="absolute contents inset-[3.51%_3.8%_90.06%_71.02%]">
      <div className="absolute bg-[#018d37] inset-[3.51%_3.8%_90.06%_71.02%] rounded-[16px]" />
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold inset-[3.51%_3.8%_90.06%_71.02%] justify-center leading-[0] not-italic text-[15px] text-center text-white">
        <p className="leading-[normal]">Đang diễn ra</p>
      </div>
    </div>
  );
}
...
function Group15() {
  return (
    <div className="absolute contents inset-[3.51%_3.8%_90.06%_71.02%]">
      <div className="absolute bg-[#0770e0] inset-[3.51%_3.8%_90.06%_71.02%] rounded-[16px]" />
      <div className="absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold inset-[3.51%_3.8%_90.06%_71.02%] justify-center leading-[0] not-italic text-[15px] text-center text-white">
        <p className="leading-[normal]">Sắp diễn ra</p>
      </div>
    </div>
  );
}
...
function ChanTrang() {
  return (
    <div className="absolute contents left-0 top-[calc(60%+373.4px)]" data-name="Chân trang">
      <div className="absolute bg-[rgba(255,255,255,0.8)] h-[383px] left-0 top-[calc(60%+373.4px)] w-[1440px]" />
      <div className="absolute h-[123px] left-0 top-[calc(80%+92.2px)] w-[439px]" data-name="Thêm tiêu đề (2) 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgThemTieuD21} />
      </div>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[calc(25%+126px)] not-italic text-[#414853] text-[24px] top-[calc(80%+145.2px)] whitespace-nowrap">Khám phá</p>
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[71px] not-italic text-[#414853] text-[16px] top-[calc(80%+230.2px)] whitespace-nowrap">
      ...
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[calc(25%+326px)] not-italic text-[#414853] text-[24px] top-[calc(80%+145.2px)] whitespace-nowrap">Sản xuất</p>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%+171px)] not-italic text-[#414853] text-[24px] top-[calc(80%+145.2px)] whitespace-nowrap">Khám phá</p>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[calc(75%+31px)] not-italic text-[#414853] text-[24px] top-[calc(80%+145.2px)] whitespace-nowrap">Liên hệ</p>
      <div className="absolute left-[calc(50%+24px)] overflow-clip size-[51px] top-[calc(80%+266.2px)]" data-name="Component 2">
        <div className="absolute inset-[8.33%]" data-name="Vector">
      ...
      <div className="absolute left-[calc(25%+185px)] overflow-clip size-[51px] top-[calc(80%+266.2px)]" data-name="Component 3">
      ...
      <div className="absolute left-[calc(50%+121px)] overflow-clip size-[54px] top-[calc(80%+266.2px)]" data-name="Component 4">
      ...
      <div className="absolute left-[calc(25%+273px)] overflow-clip size-[65px] top-[calc(80%+259.2px)]" data-name="Component 1">
...
export default function HTrTinTcSKin() {
  return (
    <div className="bg-white relative size-full" data-name="Hỗ trợ tin tức/ Sự kiện">
      ...
      <div className="absolute h-[843px] left-[-30px] top-[calc(40%-1.4px)] w-[1500px]" data-name="image 60">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage17} />
      </div>
      <div className="absolute h-[843px] left-[-30px] top-[calc(80%+85.2px)] w-[1500px]" data-name="image 61">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage17} />
      </div>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[39px] not-italic text-[0px] text-[rgba(0,0,0,0.3)] top-[202px] whitespace-nowrap">
      ...
      <Group />
      <div className="absolute bg-white h-[1166px] left-[39px] rounded-[8px] top-[312px] w-[1365px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[61px] not-italic text-[24px] text-black top-[331px] w-[676px]">TRẠNG THÁI SỰ KIỆN VÀ HOẠT ĐỘNG</p>
      <div className="absolute h-[342px] left-[63px] top-[calc(20%-4.2px)] w-[421px]">
        <Group2 />
      </div>
      <div className="absolute h-[342px] left-[63px] top-[calc(20%+357.8px)] w-[421px]">
        <Group4 />
      </div>
      <div className="absolute h-[342px] left-[63px] top-[calc(40%+341.6px)] w-[421px]">
        <Group6 />
      </div>
      <div className="absolute h-[342px] left-[calc(25%+149px)] top-[calc(20%-4.2px)] w-[421px]">
        <Group8 />
      </div>
      <div className="absolute h-[342px] left-[calc(25%+151px)] top-[calc(20%+357.8px)] w-[421px]">
        <Group10 />
      </div>
      <div className="absolute h-[342px] left-[calc(25%+149px)] top-[calc(40%+341.6px)] w-[421px]">
        <Group12 />
      </div>
      <div className="absolute h-[342px] left-[calc(50%+235px)] top-[calc(20%-4.2px)] w-[421px]">
        <Group14 />
      </div>
      <div className="absolute h-[342px] left-[calc(50%+235px)] top-[calc(20%+357.8px)] w-[421px]">
        <Group16 />
      </div>
      <div className="absolute h-[342px] left-[calc(50%+235px)] top-[calc(40%+341.6px)] w-[421px]">
        <Group18 />
      </div>
      <Group1 />
      <Frame3 />
